...
const styleCountryMobile =
  "grid md:hidden pb-5 md:pb-0 justify-center text-brownfont font-poppinsMedium text-xl";
const styleCountry =
  "hidden md:flex justify-center text-brownfont font-poppinsMedium text-xl";
  ...
  return (
    <div className="h-full grid bg-white pt-14 md:pt-24 xl:py-24 px-7 sm:px-16 xl:px-32 2xl:px-52">
      <div className="grid xl:container xl:mx-auto justify-items-center content-center space-y-10">
        ...
        >
          <span className="text-brownfont">Check Our Best</span> {""}
          Promotional Tour
        </h1>
        ...
        >
          ...
          <p className={styleCountryMobile}>Beijing</p>
          <Link href="/">
            <a className={styleDestination}>
              <img
                src={TurkeyImg.src}
          ...
          <p className={styleCountryMobile}>Turkey</p>
          <Link href="/">
            <a className={styleDestination}>
              <img
                src={PakistanImg.src}
          ...
          <p className={styleCountryMobile}>Pakistan</p>

          {/* Text below is for md screen and above */}
          <p className={styleCountry}>Beijing</p>
          <p className={styleCountry}>Turkey</p>
          <p className={styleCountry}>Pakistan</p>
        </div>
      </div>
    </div>
  );
